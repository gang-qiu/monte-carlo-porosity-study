...
class SimulatorTest(unittest.TestCase):
    def setUp(self):
        self.simulator = Simulator(width=20, height=20)
    ...
    def test_simulate_one_grid(self):
        grid_not_connected = self.simulator._simulate_one_grid(0.01)
        grid_connected = self.simulator._simulate_one_grid(0.99)
    ...
    def test_simulate_many_grids(self):
        num_times = 5
        grids = self.simulator._simulate_many_grids(num_times=num_times, porosity=0.99)
    ...
    def test_get_average_percolation_rate_for_porosity(self):
        average_percolation_rate = self.simulator.get_average_percolation_rate_for_porosity(porosity=0.6)
    ...
    def test_get_average_percolation_rate_for_porosity_list(self):
        ...
        percolation_rates = self.simulator.get_average_percolation_rates_for_porosity_list(porosity_list)
